"""
test_clf_patches_vnet.py

Evaluates best_model_vnet_clf_patches.pth on held-out test set.
Model 3 (VNet) — patches, 512x512.
"""
...
BATCH_SIZE  = 4
NUM_WORKERS = 8
RESULTS_CSV = os.path.join(os.path.dirname(__file__), 'results', 'test_results_patches.csv')
ROC_PLOT    = os.path.join(os.path.dirname(__file__), 'results', 'roc_curve_patches.png')
# -------------------------------------------------------------------------
...
def main():
    ...
    print("\n" + "="*50)
    print("TEST SET RESULTS — Model 3 VNet (Patches)")
    print("="*50)
    ...
    plt.title('ROC Curve — Model 3 VNet (Patches)')
