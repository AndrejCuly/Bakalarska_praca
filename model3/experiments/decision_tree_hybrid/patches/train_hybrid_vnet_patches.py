...
Run extract_features_vnet_patches.py first.
"""
...
def main():
    ...
    ax.set_title('ROC Curves — Model 3 VNet + Classical ML (Patches)')
    ...
    print("\n" + "="*60)
    print("SUMMARY — Model 3 VNet Hybrid (Patches)")
    print("="*60)
    ...
    with open(RESULTS_FILE, 'w') as f:
        f.write("HYBRID EXPERIMENT RESULTS — Model 3 VNet (Patches)\n")
        f.write("="*60 + "\n\n")
