...
Compatible with cached .pt tensor files (see cache_dataset.py).
"""
...
def main():
    ...
    print("\n" + "="*50)
    print("TEST SET RESULTS — Model 1 (3D CNN from scratch)")
    print("="*50)
    ...
    plt.title('ROC Curve — Model 1 3D CNN (Whole Mammograms)')
