...
Evaluates best_model_clf.pth on the held-out test set.
For model1_experiment (384x512 rectangular images).
"""
...
# Config
# -------------------------------------------------------------------------
CANCEROUS_TEST   = r"C:\Users\culya\Desktop\data_bakalarka\data\dataset_processed_v2\test\cancerous"
CANCER_FREE_TEST = r"C:\Users\culya\Desktop\data_bakalarka\data\dataset_processed_v2\test\cancer_free"
...
def main():
    ...
    print("\n" + "="*50)
    print("TEST SET RESULTS — Model 1 v2 (384x512 images)")
    print("="*50)
    ...
    plt.title('ROC Curve — Model 1 v2 (Whole Mammograms 384x512)')
