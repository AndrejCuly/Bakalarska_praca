...
Run extract_features_resnet50_patches.py first.
"""
...
RESULTS_DIR  = os.path.join(os.path.dirname(__file__), 'results_patches')
ROC_PLOT     = os.path.join(RESULTS_DIR, 'roc_curves_hybrid_resnet50_patches.png')
RESULTS_FILE = os.path.join(RESULTS_DIR, 'hybrid_results_resnet50_patches.txt')
# -------------------------------------------------------------------------
...
def main():
    ...
    ax.set_title('ROC Curves — Model 4 ResNet50 3D + Classical ML (Patches)')
    ...
    print("\n" + "="*60)
    print("SUMMARY — Model 4 ResNet50 3D Hybrid (Patches)")
    print("="*60)
    ...
    with open(RESULTS_FILE, 'w') as f:
        f.write("HYBRID EXPERIMENT RESULTS — Model 4 ResNet50 3D (Patches)\n")
        f.write("="*60 + "\n\n")
