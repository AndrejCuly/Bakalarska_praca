"""
train_clf_resnet50.py

Classification training for Model 4 (ResNet50 3D) on whole mammograms.
512x512 images, dataset_processed split.
"""
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        for i, (views, pad_mask, labels, patients) in enumerate(train_loader):
            ...
            total_norm = torch.nn.utils.clip_grad_norm_(model.parameters(), 0.1)
